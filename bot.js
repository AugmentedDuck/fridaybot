...
client.on(Events.InteractionCreate, async interaction => {
  ...
  try {
    ...
    if (interaction.replied || interaction.deferred) {
      await interaction.followUp({ content: `There was an error wile executing this command`, ephemeral: true });
    } else {
      await interaction.reply({ content: `There was an error wile executing this command`, ephemeral: true });
    }
  }
